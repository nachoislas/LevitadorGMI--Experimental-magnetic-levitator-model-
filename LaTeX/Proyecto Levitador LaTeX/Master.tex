...
\title{Sistema automatizado de estacionamiento}
\shorttitle{}
\englishtitle{}

\author{Sebastián Alejandro Gregoracci \\ Juan Pablo Valeo}
\authoreng{}

\departamento{Departamento de Electrónica y Computación}

\director{Dra. Leticia María Seijas}
\codirector{Ing. Juan Alberto Etcheverry}

\thesisdate{día X de Marzo del año 2020}
\thesisdateeng{}

\dedication{\textit{	COMPLETAR la "DEDICATION" que se encuentra junto con "title" en el Master.tex	.}}

\affiliation{El presente trabajo de tesis fue realizado en el Laboratorio de Comunicaciones del Departamento de Electrónica y Computación, ICyTE, Facultad de Ingeniería, Universidad Nacional de Mar del Plata.}
...
\include{Controlador/Controlador}

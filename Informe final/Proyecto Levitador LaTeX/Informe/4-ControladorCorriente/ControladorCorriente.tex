...
Estos funcionan bajo el fenómeno físico llamado efecto Hall, en el que al incidir un campo magnético en un semiconductor se genera una acumulación de portadores, que produce una diferencia de tensión. Los sensores de corriente que funcionan bajo este principio tienen un bobinado por el que circula la corriente, y en el medio se encuentra la pastilla de semiconductor.
...
\begin{itemize}
	\item Debe ser capaz de medir una corriente de hasta 30A.
	\item El ancho de banda debe ser mucho mayor al polo de la frecuencia de conmutación del controlador de corriente para poder conservar la forma de onda de la corriente triangular a medir. Por lo tanto, debe ser al menos de 100kHz.
	\item La transresistencia debe ser lineal entre 0A y 30A.
	\item Buena resolución y presicion en la medicion.
	\item Inmunidad a campos magnéticos externos	
\end{itemize}

A partir de estas caracteristicas se decicdio utilizar el sensor HO 15-NP-0000, el cual permite medir una corriente de $\pm 37.5 A$ con un ancho de banda de $250 kHz$. Ademas este sensor esta aislado galvanicamente por lo tanto es inmune a ruido en modo comun, posee alta inmunidad a interferencias externas, y presenta una tension de offset magnetica muy baja ( $\pm 6 mV$). 

En cuanto a la sensibilidad y linearidad, el sensor posee una sesibilidad de $53,33 mV/A$ en el rango de medicion y se especifica un error de linealidad porcentual en terminos de la corriente($\pm 0.8 $) el cual indica el error en la regresion lineal y los puntos medidos por el fabricante. Ademas este sensor permite tener una salida sobre un offset de tension configurado por el usuario, esto evita la necesidad de la implementacion de fuentes de tension negativas para excursiones de corriente negativas. Por este 

Entonces el bloque H de realimentacion queda definido como:

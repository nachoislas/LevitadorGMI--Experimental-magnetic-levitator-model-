...
Como se mencionó en la sección \ref{sec_descripcion-del-dispositivo} para poder controlar la posición es necesario modificar la fuerza que ejerce el electroimán. 
...
En ella se ve que la fuerza magnética depende de la corriente del bobinado. Por lo tanto, esta fuerza puede ser regulada al modificar la corriente. De esta forma, se decide implementar un controlador de corriente que sea capaz de controlar la corriente que circula por el electroimán a partir de una tensión de referencia correspondiente al valor de corriente deseado. 
...
La informacion de la distancia de entrehierro se encuentra en la pendiente de la onda triangular de la corriente. Por ello se parte de la expresión \ref{eq_corriente_taylor_2} y se obtiene la pendiente a partir de su derivada temporal:

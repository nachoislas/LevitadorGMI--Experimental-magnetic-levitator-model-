...
En esta sección se aborda el diseño circuital de la etapa de compensación planteada en el diagrama \ref{fig:diag-en-bloques-comp}. Se realiza el diseño en orden desde la entrada $V_{y_{ref}}$ hasta llegar al compensador del lazo interno.
...
\begin{equation} 
	tlc = \frac{G^-}{H}  = \frac{SC_xR_x+1}{SC_x[R_1+R_x]+1}=\frac{\frac{s}{44.3}+1}{\frac{s}{902.1}+1}
\end{equation}

...
\begin{figure}[H]
	...
	\caption{Simulación de escalón en la referencia de corriente mostrando conmutación de alimentación en el electroimán. Con fines demostrativos únicamente, esta simulación fue realizada con una frecuencia de conmutación auxiliar menor a la utilizada en el diseño. Esto con el fin de que se puedan representar correctamente en una misma imagen las señales de baja frecuencia y la de conmutación.}

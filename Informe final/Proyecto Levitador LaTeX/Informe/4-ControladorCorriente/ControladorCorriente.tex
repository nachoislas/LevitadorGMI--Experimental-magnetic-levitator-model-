...
\subsubsection{Elección de llaves de conmutación}

Las llaves de conmutación (Q1, Q2, Q3 y Q4) que se muestran en la figura 3.9 deben ser elegidas con cuidado. Idealmente deberían presentar resistencia nula al estar cerradas, de esta forma no se modifica la dinámica de la planta y se reduce la disipación de potencia.
...
https://www.allaboutcircuits.com/technical-articles/fet-vs-bjt-vs-igbt-whats-the-right-choice-for-your-power-stage-design/
...
\subsubsection{Elección de driver de corriente}

Para lograr una conmutación sincronizada de los MOSFET(ya explicamos antes que vamos a isar mosfet) se necesita un dispositivo que permita manejar activar los pares de transistores de forma sincronizada con una senial adecuada. Estos circuitos también llamados DRIVERS de corriente son encapsulados que poseen toda la circuiteria para hacerlo.....

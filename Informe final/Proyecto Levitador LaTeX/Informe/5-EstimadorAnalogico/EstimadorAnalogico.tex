...
En la tabla \ref{tab_Resultados_de_simulación_del_estimador} se muestran valores medidos y los calculados teóricamente (\ref{tab_Vyf_vs_y}) de $V_{estim}$ en función de la posición.

...
En esta sección se planteará la topología ideal que conforma el bloque amplificador planteado en la figura \ref{fig:img_diag-en-bloques-conH-y-Kin}. Se encarga de entregar la tensión $V_L$ al electroimán a partir del valor de la señal de entrada $V_h$. $V_L$ puede tomar dos valores de tensión posibles: $V_L=+Vcc$ si $V_h=5\:V$, o $V_L=-Vcc$ si $V_h=0\:V$.

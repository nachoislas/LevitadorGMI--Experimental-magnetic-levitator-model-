...
Para la implementación circuital del rectificador se decidió utilizar la misma topología usada en la versión anterior del prototipo, la cual está compuesta por tres etapas: rectificación, restador y filtrado. Para facilitar la comprensión de este circuito, se realiza un análisis de cada una de estas etapas por separado.

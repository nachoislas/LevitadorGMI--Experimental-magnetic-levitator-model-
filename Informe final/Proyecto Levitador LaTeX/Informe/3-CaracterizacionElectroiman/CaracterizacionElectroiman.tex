...
Además se adoptan nuevas variables de estado equivalentes a las anteriores pero desplazadas por sus puntos de equilibrio:
...
Dado que el objetivo de este sistema en particular es mantener la pieza en forma de “I”  suspendida a una distancia determinada, se puede considerar la linealización en torno a ese punto de equilibrio. Debido a que el sistema va a trabajar entre 3 y 5mm, se elige como punto de equilibrio $x_{1o}=4\:mm$.
...
\begin{equation}\label{eq_transferencia_planta}
	G_{P}=C*(s*I-A)^{-1}*B=-\sqrt{\frac{K}{g*M}}*\frac{1}{{\frac{s}{\sqrt{\frac{2*g}{y_{o}}}}^2-1}}
\end{equation}

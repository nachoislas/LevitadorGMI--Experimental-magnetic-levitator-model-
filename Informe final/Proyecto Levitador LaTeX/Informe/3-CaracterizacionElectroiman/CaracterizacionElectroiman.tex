...
Como se observa en el sistema de ecuaciones \ref{eq_modelo_estados}, únicamente la función $f_2(x_1,x_2,u)$ es no lineal. Por lo tanto se procede a su linealización en torno a los puntos de equilibrio \ref{eq_puntos_equil}. La serie de Taylor para un sistema con dos variables de estado y una entrada hasta el factor de primer orden queda definida como:
...
En la ecuación \ref{eq_taylor} el primer término correspondiente a la función $f_2(x_{1o},x_{2o},u_o)$ es igual a cero, ya que es la función en el punto de equilibrio. Además, el coeficiente $J_2$ es nulo ya que la variable $x_2$ no interviene en la función $f_2$. Finalmente el sistema linealizado queda: 

...
Para resolver este circuito se plantea lo siguiente:
...
\section{Cálculo de los coeficientes del controlador}
 ...
 Para implementar el algoritmo de control en el microcontrolador se aplica la transformada bilineal inversa a la transferencia del compensador externo $G_{ext}(w)$.
...
\colorbox{red}{rehacer lo de abajo}

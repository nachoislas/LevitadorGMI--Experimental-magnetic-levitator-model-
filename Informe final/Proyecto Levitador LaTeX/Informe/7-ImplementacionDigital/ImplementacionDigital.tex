...
\colorbox{yellow}{Ver si se puede poner bien el delta..}
...
\noindent Debido a que el ADC permite una excursión entre $0\:V$ y $3.3\:V$, la máxima ganancia posible es de 60 veces para la señal de alterna \colorbox{yellow}{¿No debería ser de 120 veces? 26.7 es pico pico..}. Por otro lado, para medir con la resolución en posición deseada de $0.1\:mm$ se debe amplificar la señal triangular 9 veces como mínimo.

\noindent Por lo tanto, se adopta una ganancia de 50, y se obtiene una excursión máxima de $3.17\:V$ (es decir, $0.67\:V$ sobre el set-point). \colorbox{yellow}{Ver si esta bien calculado el 3.17, pq los 26.7 son pico pico..}

...
Para lograr una formad de onda mostrada en la  fig 3.3 el controlador actua de la siguiente manera. 

Al iniciar la corriente iL aumentara de forma exponencial hasta que el valor de ie sea deltaIL/2.En este el bloque de histeresis actua y se conmuta la tension Vh a -VCC.

Al hacer esto la corriente comienza a decrecer hatsta que el error es igual a -deltaiL/2. De igual forma, en este punto el bloque coomparador actua y la tension vh conmuta +VCC. Este ciclo se repite indefinidamente siempre y cuando la iref sea constante.
%%

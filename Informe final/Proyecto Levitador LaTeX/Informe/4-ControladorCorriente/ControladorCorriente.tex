...
En ella se ve que la fuerza magnética depende de la corriente del bobinado. Por lo tanto, para regular esta fuerza, se implementa un controlador (o driver) de corriente que modifica su intensidad y, por ende, la de la fuerza electromagnetica generada.
...
Por lo tanto, es necesario diseñar un controlador (o \textsl{driver}) de corriente que sea capaz de entregar la corriente requerida, y que esta sea controlada por una tensión de entrada de referencia.

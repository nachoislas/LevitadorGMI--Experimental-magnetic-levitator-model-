...
Dado que $V_{iLRef}$ se multiplica por la ganancia $K_{in}$ y luego se le resta el valor de $V_{iLF}$, todo esto sobre un setpoint $V_{op}$ se obtienen las siguientes relaciones:

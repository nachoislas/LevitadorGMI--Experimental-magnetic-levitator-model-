...
\colorbox{red}{Agregar en la imagen los TVS y agregar S1, S2, S3 y S4, y 24V; sacar capacitores; agregar resistencia y diodo en serie a los gates}

\subsubsubsection{Resistencias de descarga de gate}\label{sec_res-gate}
...
\subsubsubsection{Protección de sobretensión del gate}
...
\subsubsubsection{Resistencia y diodo en serie al gate}
...
\colorbox{red}{Repetir imagen 1.9 pero con capacitores de fuente}
...
\noindent Se decidió utilizar 6 capacitores  \colorbox{red}{poner nombre} de $2200 \:uF$ con un rating de tensión de $50\:V$ y una ESR de $17 \:\Omega$ (datos obtenidos de \cite{EKY-350ELL222MM25S}) . De esta forma, al reemplazar en la ecuación \ref{eq_potencia} se obtiene que la potencia disipada es de: 
...
\colorbox{red}{IMAGEN DE LOS DOS CIRCUITOS JUNTOS}

\subsection{Comparador con histéresis}

Como se mencionó en la sección \ref{sec_cap_bootstrap} es necesario agregar una etapa de oscilación de alta frecuencia para permitir la carga de los capacitores de bootstrap en un intervalo de tiempo regular.

Para implementar el oscilador de alta frecuencia se propone la topología circuital mostrada en la figura \ref{fig:img_frecuencia-auxiliar}. Esta genera una señal pulsada con ciclo de trabajo 90\% en su salida a partir de el valor de la tensión $V_h$ en su entrada con el agregado de una inversión de signo. Pueden darse dos casos:

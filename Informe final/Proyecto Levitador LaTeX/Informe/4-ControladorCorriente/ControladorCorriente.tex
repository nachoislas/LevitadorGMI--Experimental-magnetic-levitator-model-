...
\colorbox{yellow}{De última, si se complica, podemos decir algo así: "Para obtener una frecuencia de 50kHz, se ajusta el valor del capacitor C1 a xxx pF, manteniendo el resto de los componetes con el mismo valor." .....tipo sin poner la fórmula}
...
\subsubsection{Circuito de la etapa de conmutación completo}
\colorbox{red}{Ver nombre de título..}
...
\colorbox{red}{Agregar hoja de datos?}
...
\colorbox{red}{Aca lo que podríamos agregar es algo así: }
"Si bien la conmutación con histéresis se detuvo, la conmutación auxiliar siguió conmutando (Agregar otra imagen que lo muestre) con el ciclo de trabajo constante hasta qeu la histéresis hizo que vuelva a cambiar,. Sin embargo en todo momento hubo conmutación para la carga de los bootstrap"

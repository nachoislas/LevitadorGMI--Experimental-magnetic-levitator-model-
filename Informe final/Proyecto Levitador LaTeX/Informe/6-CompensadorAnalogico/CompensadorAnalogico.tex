...
\subsection{Análisis de estabilidad con masa de 30Kg}

\noindent Para el análisis del compensador analogico se parte de las transferencias de la planta $G_{p}(s)$ para una masa de 30 Kg, la del controlador de corriente $G_{iL}(s)$  y el lazo de realimentación H estim. A partir de ellas se obtiene  la transferencia a lazo abierto mostrado en la ecuación \ref{eq_GT2}.


\begin{equation} \label{eq_GT1}
	G_T(s)[30Kg]*H_{estim}=G_{p}(s)*
	G_{iL}(s)*H_{estim} 
\end{equation}

\begin{equation} \label{eq_GT2}
	G_T(s)[30Kg]*H_{estim}=\frac{0.38}{(1-(\frac{s}{70}))*(\frac{S}{12.17\ }+1)*(1+\frac{s}{1\ Krad/s})*{(1+\frac{s}{60\ Krad/s})}^2 }	
\end{equation}
...
\begin{figure}[H]
	\centering
	\includegraphics[scale=0.7]{Bode-k-1-M-30.png}
...
\begin{figure}[H]
	\centering
	\includegraphics[scale=0.7]{Bode-k-10-M-30.png}
...
\begin{figure}[H]
	\centering
	\includegraphics[scale=0.7]{Nyquist-k-10-M-30.png}
...
\begin{figure}[H]
	\centering
	\includegraphics[scale=0.7]{Respuesta-al-escalon-K-10-M-30Kg.png}
...
\begin{figure}[H]
	\centering
	\includegraphics[scale=0.4]{bodecompensado1kg.png}
...
\begin{figure}[H]
	\centering
	\includegraphics[scale=0.6]{nyquistcompensado1kg.png}
...
\begin{figure}[H]
	\centering
	\includegraphics[scale=0.8]{rtaescaloncompensado1kg.png}
	\caption{Respuesta al escalón para M=1 Kg.}
	\label{fig:respuesta-analog-al-escalon-para-M-1Kg}
\end{figure}

\subsection{Diseño circuital de la red de adelanto de fase}
...
\begin{figure}[H]
	\centering
	\includegraphics[scale=0.7]{rlocusconintegrador30kg.png}
...
\begin{figure}[H]
	\centering
	\includegraphics[scale=0.7]{stepresponseintegradorkint_50_m_30.png}
...
\begin{figure}[H]
	\centering
	\includegraphics[scale=0.5]{stepresponseintegradorkint_50_m_1.png}

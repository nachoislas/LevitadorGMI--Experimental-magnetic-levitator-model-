...
Como ya se dispone de un electroimán para cumplir la función de actuador, se realizará un modelado físico de su funcionamiento y a partir de sus características constructivas, se determinarán otros parámetros del sistema de control (como masa máxima, corriente nominal de trabajo, etc)

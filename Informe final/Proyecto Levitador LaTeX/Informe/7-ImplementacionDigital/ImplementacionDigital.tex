...
\colorbox{red}{Aclaramos para que se usa R403?}
...
Para el dimensionamiento de los valores de los componentes del circuito de la figura \ref{fig:DAC-estimador} se utilizan los mismos criterios que para el circuito \ref{fig:DAC-compensador}. por lo tanto, resulta: $C_{403}=18\:nF$, $R_{407}=5\:k\Omega$ y $R_{406}=10\:k\Omega$.

...
A continuación se describe la implementación circuital de cada una de las etapas que compponen al diagrama en bloques \ref{fig:img_diag-en-bloques_estimador}.
...
\end{equation}
\colorbox{red}{Esta bien que vaya el modulo en la ecuación de arriba?}
...
\colorbox{red}{volví a hacer la simulación y me dio esta respuesta en frecuencia. Los componentes me dieron igual}

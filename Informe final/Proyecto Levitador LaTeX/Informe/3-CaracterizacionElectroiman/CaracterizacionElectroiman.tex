...
Estas matrices ahora serán utilizadas para obtener la función transferencia de la planta que luego será de utilidad para el diseño del compensador. Para obtenerla se utiliza la expresión \ref{eq_transferencia_planta}.

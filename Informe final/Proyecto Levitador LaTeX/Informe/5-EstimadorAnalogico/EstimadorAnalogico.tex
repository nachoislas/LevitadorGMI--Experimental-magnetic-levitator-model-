...
\colorbox{red}{cambiar imagen para usar Vilfeed y vop y vderiv.}
...
\begin{equation} \label{eq_Vyf-Vbias3}
	V_{bias} =-\frac{R_4}{R_3}(H_0I_L+ 0.1\:V)+V_{Ref_{bias}}(1+\frac{ R_4}{R_3})(\frac{R_1}{R_1+R_2})
\end{equation}

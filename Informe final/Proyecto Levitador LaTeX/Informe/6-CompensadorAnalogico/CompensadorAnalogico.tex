...
\colorbox{red}{En que etapa se cancela?}
...
\colorbox{red}{Acá habría qeu hacer una intro o algo tambien...}
\begin{figure}[H]
	\centering
...
Para cada etapa del compensador por adelanto se utiliza la topología mostrada en la figura \ref{fig:red-adelanto-fase}. Se desea obtener una transferencia como la calculada en (eq del compensador). A continuación se hace un análisis de este circuito y la elección de los componentes. 

...
\noindent La salida de esta etapa es:

\begin{equation} 
	Vaf_{out}= 2.5\:V* (1+\frac{R_a}{R_b})- Vaf_{in}*\frac{R_a}{R_b}*\frac{1+sC(R_x+R_1)}{1+sCR_x}
\end{equation}

\noindent La transferencia de lazo cerrado de esta etapa sin considerar su punto de operación es:
...
\begin{figure}[H]
	\centering
	\includegraphics[scale=0.8]{Etapa-de-entrada-sumador.png}

...
Al tomar muestras se esta discretizando una senial continua, para hacer esto, se utilizan conversores analógico digitales que mantienen el valor de esta entre muestra y muestra. Este tipo de reconstrucción de senial también se lo llama $ROC$ y se lo puede modelar con la siguiente ecuación:
...
\begin{equation} 
	F_{ADC} \geq 2.5 * 5 * F_{planta_{max}} \Rightarrow  F_{ADC} \geq 2.5 * 5 * 1666 Hz \Rightarrow F_{ADC} \geq 20825\:Hz
\end{equation}

\colorbox{red}{esta de 1666 no coincide con la de 5mm en la tabla pero igual no nos modificaría el resultado}
...
\begin{equation*} 
	X=\frac{1}{sc_{408}}//R_{411}=\frac{1}{sc_{409}}//R_{414}
\end{equation*}
...
\begin{equation*} 
	V_{pos\_Ref\_ADC}=\frac{X}{X+R_{413}}V_{pos\_Ref}-\frac{X}{R_{412}}*2.5\:V
\end{equation*}

Si se considera que $R_{412}=R_{413}=R_{412}$ se obtiene:
...
\colorbox{red}{ponemos diagrama general de la compensación?}

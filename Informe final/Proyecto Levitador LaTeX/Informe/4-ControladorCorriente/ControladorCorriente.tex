...
\noindent Para el dimensionamiento se tuvieron en cuenta sugerencias y procedimientos descriptos en \cite{Prueba123} y [2].
...
\colorbox{yellow}{------------------Ver de achicar esta ecuacion--------------------}
\begin{equation} \label{eq_cap-bootstrap2}
C_{BS} > \frac{Q_G+Q_{RR} + \frac{I_{DR}+I_{GS}}{f_{PWM}}}{\Delta V_B}>\frac{170 nC + 0.625nC + \frac{2 mA + 2.55 mA}{50 KHz}}{0.1 V} > 2.61 \mu F
\end{equation}
...
\noindent Considerando  $\Delta I_L=500 mA$ y $T=0.47ms$ que corresponde a $Y = 2 mm$ según la \colorbox{yellow}{Tabla 4.1.}
...
TLC_{CC} = \frac{64}{1+\frac{s}{\omega _{polo}}}
\end{equation}

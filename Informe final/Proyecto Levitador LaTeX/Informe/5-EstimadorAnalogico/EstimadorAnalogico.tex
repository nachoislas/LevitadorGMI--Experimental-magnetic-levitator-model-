...
\colorbox{red}{acá como que ya partimos sabiendo como va a estar armado todo, capaz conviene empezar armandolo dsde el derivador, despues rectificador, después compensación I*R, etc.. sin decir de antemano cómo va a ser}
...
\colorbox{red}{acá se podría hacer referencia al análisis que hicimos en el cpaitulo 3 y nos ahorramos el analisis de las ecuaciones}
´
...
\end{equation}
 ...
 \colorbox{red}{podemos partir directamente desde la inductancia total linealizada}

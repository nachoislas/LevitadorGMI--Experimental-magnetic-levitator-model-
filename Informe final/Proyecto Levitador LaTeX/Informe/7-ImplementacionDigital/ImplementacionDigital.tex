...
\begin{equation} 
	Y_g[n] = 5.136*10^{-6}* |\frac{I_L[n]-I_L[n-K]}{K*T_S}+\frac{R*I_L[n]}{L(Y_g)[n-1]}| - 3.472*10^{-3} [m]
\end{equation}

\colorbox{yellow}{Pq es el modulo de la suma y no de la resta?}
...
\begin{figure}[H]
	\centering
	\includegraphics[scale=0.75]{Lugar_de_raices.png}

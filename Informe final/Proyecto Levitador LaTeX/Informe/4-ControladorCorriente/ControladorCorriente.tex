...
\noindent Para regular la fuerza ejercida por el electroimán es necesario controlar la corriente que circula por él. Para ello, se modela a la planta como la admitancia de un circuito RL serie. En el capítulo \ref{cap:CaracterizacionElectroiman} se determinó que la inductancia varía con el entrehierro. Por lo tanto, la expresión resulta: \colorbox{red}{deberíamos poner que la admitancia es Y??}

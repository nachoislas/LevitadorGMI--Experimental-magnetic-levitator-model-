...
%definiciones de parametros para el dibujo
\tikzstyle{block} = [draw, fill=blue!20, rectangle, 
minimum height=4.5em, minimum width=6em]
...
\thesisdate{\textcolor{red}{día X de Julio del año 2022}}
\thesisdateeng{}

\dedication{\textit{Dedicación}}
...
\include{Informe/1-Introduccion/Introduccion}
\include{Informe/3-CaracterizacionElectroiman/CaracterizacionElectroiman}
\include{Informe/4-ControladorCorriente/ControladorCorriente}
\include{Informe/5-EstimadorAnalogico/EstimadorAnalogico}
\include{Informe/6-CompensadorAnalogico/CompensadorAnalogico}
\include{Informe/7-ImplementacionDigital/ImplementacionDigital}
\include{Informe/8-PCB/PCB}
\include{Informe/9-Conclusion/Conclusion}

%\include{Estructura-sist/Estructura-sist-v1}
%\include{Cap_Patentes/Cap_Patentes-v1}
%\include{2do-Nucleo/2do-Nucleo-v1}
%\include{Primer_prototipo/Primer_prototipo-v2}
%\include{Conclusiones/conclusiones-v1}
%\include{Varios/Varios-v1}

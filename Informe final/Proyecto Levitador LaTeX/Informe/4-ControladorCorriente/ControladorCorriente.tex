...
Para su implementación se propone la topología circuital mostrada en la figura \ref{fig:img_frecuencia-auxiliar}. Este oscilador fue utilizado en la versión anterior del prototipo para conmutar con un ciclo de trabajo del 90\%. Por lo tanto, se decide seguir con esta topología ajustando el valor de $C_1$ para obtener una frecuencia de conmutación de $50\:KHz$. Este circuito presenta, además, una inversión de signo a su salida.

La frecuencia de conmutación se calcula como:

\begin{equation} 
	 C_1= \frac{4.5*10^{-5}}{F_{aux}} = 900pF [Hz]
\end{equation}

...
\noindent La implementación digital consiste, básicamente, en realizar la estimación de posición y el control de la planta por medio de un microcontrolador. Se utiliza un kit de desarrollo basado en el microcontrolador STM32F072, que contiene un ADC de 12 bits y $3.3\:V$ de referencia, un DAC 12 bits y $3.3\:V$ de referencia. \colorbox{yellow}{esto del ADC y DAC se podria juntar..}\\

...
\colorbox{yellow}{Capaz podríamos sacar esta sección. No aporta nada me parece..}\\
\noindent 
...
\colorbox{yellow}{Tal vez conviene ponerle 0.17V aprox y redondear a 0.2V}
\\
...
\colorbox{yellow}{Aca no explicamos el procedimiento como con la resistencia?}
\\
\colorbox{yellow}{Capaz conviene borrar el procedimiento de la resistencia..}
\\
...
\begin{itemize}
	...
	\item L: inductancia resultante en Henry [Hy].
\end{itemize}
\colorbox{yellow}{Ver si esto vuela}

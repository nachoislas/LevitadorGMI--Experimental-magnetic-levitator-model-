...
Un ejemplo de levitación sería el de utilizar un imán permanente y un objeto de material ferromagnético enfrentados en un eje vertical. Si se sujeta el imán desde arriba, y el objeto se coloca por debajo, al momento en que éste se suelta se consigue una levitación por un instante de tiempo, pero luego la fuerza de atracción provoca que ambos se peguen.  Esto es debido a que no es posible obtener una levitación estática por medio de campos magnéticos permanentes (Teorema de Earnshaw).

...
\begin{figure}[H]
	...
	\caption{Acercamiento del diagrama de Nyquist de $GH_T$ con $M=30\:kg$.}
...
\begin{figure}[H]
	\centering
	\includegraphics[scale=0.45]{rlocus_planta_30kg.png}
...
\begin{figure}[H]
	\centering
	\includegraphics[scale=0.45]{rlocus_planta_30kg_zoom.png}
	\caption{Acercamiento del lugar de raíces de $GH_T$ con $M=30\:kg$.}

...
\noindent La expresión anterior indica que la cantidad de energía que almacena el sistema es función del gap de aire ($Y_{g}$) y de la corriente que circula por el electroimán ($i$). 
...
Si se considera las condiciones mas exigentes para el sistema, con $M=M_{max}=30kg$ e $Y_{g}=y_{max}=5mm$, se obtiene:

...
\colorbox{yellow}{podríamos volver a referenciarlo, no?}
...
\noindent La tabla \colorbox{yellow}{3.1??} muestra  entre qué valores de frecuencia se verá afectada la forma de onda al modificarse la distancia de separación.

...
\subsection{Ajuste para permitir corrientes negativas}
...
Este circuito trabaja con una tensión de salida que puede tomar dos valores como se vio anteriormente(+- Vcc). En la entrada negativa del operacional (V-) se tiene una onda triangular montada sobre un offset de 2.5 V (Ve).

Las ecuaciones son las siguientes:
\begin{equation} 
V+ = \frac{R_{7}}{R_{8}+R_{7}}*( Vh - 2.5 V)
\end{equation} 

La tensión diferencial entre las patas $V+$ y $V-$ es $Vd=(V+)-(V-)$

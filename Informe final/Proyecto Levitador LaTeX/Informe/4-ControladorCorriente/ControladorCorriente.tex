...
Al aplicar la transformada inversa de Laplace a la expresión  \ref{eq_corriente}, se puede obtener la respuesta temporal de la corriente a un escalón de tensión de amplitud ``$v$'' en la entrada:
...
\begin{equation}
Potencia_{transistor} = i_{max}*V_{alimentacion} = 30 A * V_{alimentacion}=
\end{equation}

...
La ecuación \ref{eq_fuerza_magnetica} muestra que la fuerza magnética depende del cuadrado de la corriente y del cuadrado de la inversa de la distancia del entrehierro. Es decir, se trata de un fenómeno no lineal. La desventaja que esto conlleva es que resulta complejo el diseño de un compensador adecuado.
Sin embargo, es posible considerar que el comportamiento de la planta es aproximadamente lineal en un cierto rango de operación y aplicar técnicas de compensación para sistemas lineales.

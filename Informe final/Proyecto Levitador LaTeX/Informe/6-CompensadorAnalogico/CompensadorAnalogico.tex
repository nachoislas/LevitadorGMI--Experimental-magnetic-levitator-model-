...
Finalmente en la figura XD se muestra el circuito de todas las etapas del compensador interno en cascada para obtener de esta forma la transferencia mostrada en la ecuacion \ref{eq:transferencia-del-compensador}

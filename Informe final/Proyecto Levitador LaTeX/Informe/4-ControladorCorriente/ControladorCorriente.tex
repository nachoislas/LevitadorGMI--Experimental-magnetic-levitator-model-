...
\colorbox{red}{Hay algun cálculo para ver que tan rápido se descarga? O como sabemos eso...}
...
Para el diseño del circuito impreso de esta etapa se propone en principio utilizar resistencias de 0Ohm y que, en caso de resultar necesario, puedan ser reemplazadas por un valor de resistencia adecuado. \colorbox{red}{¿Y cual sería el correcto valor de la resistencia? o nunca lo calculamos?}
...
2- Que su salida permita una excursión completa entre 0 y 5V (RRIO)
...
Se utilizó el software de simulación de circuitos electrónicos NL5 para construir una representación circuital del controlador de corriente. El circuito armado se muestra en la figura \ref{fig:circuito_simulacion_final}
